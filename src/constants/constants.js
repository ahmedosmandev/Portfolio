export const projects = [
  ...
  },
  {
    title: "TaskTrail",
    description:
      "TaskTrail: A responsive task management web app crafted with HTML, CSS, and JavaScript. Features categorized task creation and local data persistence, ensuring tasks remain accessible on revisits. Designed to showcase my proficiency in front-end development and data storage techniques.",
...
export const TimeLineData = [
  { year: 2023, text: "Started an internship as an application developer" },
  { year: 2024, text: "Graduated college" },
];
